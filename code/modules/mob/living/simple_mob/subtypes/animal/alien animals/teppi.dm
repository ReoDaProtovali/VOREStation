...
//	var/dad_id
	...
	player_msg = "Teppi are large omnivorous quadrupeds. You have four toes on each paw, a long, strong tail, and are quite tough and powerful. \
				You’re a lot more intimidating than you are actually harmful though. Your kind are ordinarily rather passive, only really rising \
				to violence when someone does violence to you or others like you. You’re not stupid though, you can commiunicate with others of \
				your kind, and form bonds with those who are kind to you, be they Teppi or otherwise. <br>- - - - -<br><span class='notice'>While \
				you may have access to galactic common, this is purely meant for making it so you can understand people in an OOC manner, for \
				facilitating roleplay. You almost certainly should not be speaking to people or roleplaying as though you understand everything \
				everyone says perfectly, but it's not unreasonable to be able to intuit intent and such through people's tones when they speak. \
				Teppi are kind of smart, but they are animals, and should be roleplayed as such.</span> <span class='warning'>ADDITIONALLY, you \
				have the ability to produce offspring if you're well fed enough every once in a while, and the ability to disable this from \
				happening to you. These verbs exist for to preserve the mechanical functionality of the mob you are playing. You should be aware \
				of your surroundings when you use this verb, and NEVER use it to prefbreak or be disruptive. If in doubt, don't use it.</span> \
				<span class='notice'>Also, to note, AI Teppi will never initiate breeding with player Teppi.</span>"
